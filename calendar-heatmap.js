...
export let calendarHeatmap = {
  ...
  .domain([0, 1, 30, 60, 150, 300, 10000])
  ...
  function drawChart() {
    ...
    dayRects = svg.selectAll('.day-cell')
      ...
      .attr('x', function (d, i) {
        ...
        return result * (SQUARE_LENGTH + SQUARE_PADDING) + 15
      })
      .attr('y', function (d, i) {
      ...
      if (chart.legendEnabled()) {
        ...
        for (let i = 4; i > 0; i--) {
          colorRange.push(color(max / i - 60))
        }
      ...
      .attr('x', function (d, i) {
        ...
        locale.days.forEach(function (day, index) {
          ...
          if (index % 2) {
            ...
            .attr('transform', 'translate(5,' + ((SQUARE_LENGTH + SQUARE_PADDING) * (index + 1) + 10) + ')')
